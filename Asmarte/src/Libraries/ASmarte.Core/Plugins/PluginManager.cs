...
using ASmarte.Core.ComponentModel;
using ASmarte.Core.Plugins;
...
namespace ASmarte.Core.Plugins
{
    /// <summary>
    ...
    public class PluginManager
    {
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(ASmarteVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
        ...
        private static IEnumerable<KeyValuePair<FileInfo, PluginDescriptor>> GetDescriptionFilesAndDescriptors(DirectoryInfo pluginFolder)
        {
            ...
            //it's required: http://www.ASmartecommerce.com/boards/t/17455/load-plugins-based-on-their-displayorder-on-startup.aspx
        ...
        private static Assembly PerformFileDeploy(FileInfo plug)
        {
            if (plug.Directory == null || plug.Directory.Parent == null)
                throw new InvalidOperationException("The plugin directory for the " + plug.Name + " file exists in a folder outside of the allowed ASmarteCommerce folder hierarchy");
        ...
        private static FileInfo InitializeMediumTrust(FileInfo plug, DirectoryInfo shadowCopyPlugFolder)
        {
            ...
            if (shadowCopiedPlug.Exists)
            {
                ...
                else
                {
                    ...
                    //More info: http://www.ASmartecommerce.com/boards/t/11511/access-error-ASmarteplugindiscountrulesbillingcountrydll.aspx?p=4#60838

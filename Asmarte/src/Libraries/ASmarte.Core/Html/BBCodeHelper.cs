...
using ASmarte.Core.Html.CodeFormatter;

namespace ASmarte.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.ASmarteCommerce.com]my site[/url]
                // becomes: <a href="http://www.ASmarteCommerce.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.ASmarteCommerce.com[/url]
                // becomes: <a href="http://www.ASmarteCommerce.com">http://www.ASmarteCommerce.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.ASmarteCommerce.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.ASmarteCommerce.com/Content/Images/Image.jpg"></img>

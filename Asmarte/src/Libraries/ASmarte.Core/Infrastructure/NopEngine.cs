...
using ASmarte.Core.Infrastructure.Mapper;
...
namespace ASmarte.Core.Infrastructure
{
    ...
    /// Engine
    /// </summary>
    public class ASmarteEngine : IEngine
    {
        #region Fields
        ...
        protected virtual void RegisterDependencies(ASmarteConfig config)
        {
            ...
            builder.RegisterInstance(config).As<ASmarteConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(ASmarteConfig config)
        {
            //dependencies
            var typeFinder = new WebAppTypeFinder();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(ASmarteConfig config)
        {
            //register dependencies

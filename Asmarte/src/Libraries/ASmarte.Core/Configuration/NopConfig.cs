...
namespace ASmarte.Core.Configuration
{
    /// <summary>
    /// Represents a ASmarteConfig
    /// </summary>
    public partial class ASmarteConfig : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var supportPreviousASmartecommerceVersionsNode = section.SelectSingleNode("SupportPreviousASmartecommerceVersions");
            config.SupportPreviousASmartecommerceVersions = GetBool(supportPreviousASmartecommerceVersionsNode, "Enabled");
        ...
        /// <summary>
        /// Indicates whether we should support previous ASmarteCommerce versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousASmartecommerceVersions { get; private set; }
        ...
        /// <summary>
        /// A list of plugins ignored during ASmarteCommerce installation
        /// </summary>

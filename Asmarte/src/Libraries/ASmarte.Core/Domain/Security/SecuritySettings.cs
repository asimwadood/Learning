...
namespace ASmarte.Core.Domain.Security
{
    public class SecuritySettings : ISettings
    {
        /// <summary>
        /// Gets or sets a value indicating whether all pages will be forced to use SSL (no matter of a specified [ASmarteHttpsRequirementAttribute] attribute)
        /// </summary>

...
namespace ASmarte.Core.Domain
{
    public class StoreInformationSettings : ISettings
    {
        /// <summary>
        /// Gets or sets a value indicating whether "powered by ASmarteCommerce" text should be displayed.
        /// Please find more info at http://www.ASmartecommerce.com/copyrightremoval.aspx
        /// </summary>
        public bool HidePoweredByASmarteCommerce { get; set; }

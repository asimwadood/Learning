...
using ASmarte.Data.Initializers;
...
namespace ASmarte.Data
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have ASmarteCommerce 2.X installed
            ...
            var initializer = new CreateTablesIfNotExist<ASmarteObjectContext>(tablesToValidate, customCommands.ToArray());

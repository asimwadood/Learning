using ASmarte.Core.Domain.Security;

namespace ASmarte.Data.Mapping.Security
{
    public partial class PermissionRecordMap : ASmarteEntityTypeConfiguration<PermissionRecord>
    {

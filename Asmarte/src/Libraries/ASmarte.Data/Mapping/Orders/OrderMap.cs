...
{
    public partial class OrderMap : ASmarteEntityTypeConfiguration<Order>
    {
        public OrderMap()
        {
            this.ToTable("Order");
            ...
            //code below is commented because it causes some issues on big databases - http://www.ASmartecommerce.com/boards/t/11126/bug-version-20-command-confirm-takes-several-minutes-using-big-databases.aspx
